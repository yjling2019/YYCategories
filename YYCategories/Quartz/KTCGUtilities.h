...
CGContextRef _Nullable KTCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable KTCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);
